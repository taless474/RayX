...
def _driver_and_analyzer(name, retire_mode, extra):
    """Tiny rayx driver run (no-op, gitignored scratch) + analyzer rollup.
    ...
    """
    out = os.path.join(SCRATCH, f"{retire_mode}.jsonl")
    drv = _run([PY, "bench/run_hpx_python_baseline.py", "--api", "engine",
